...
$string['facebookurl_desc'] = 'Endereço da página de Facebook';
$string['instagramurl'] = 'Endereço Instagram';
$string['instagramurl_desc'] = 'Endereço da página de Instagram';
$string['pinteresturl'] = 'Endereço Pinterest';
$string['pinteresturl_desc'] = 'Endereço da página de Pinterest';
$string['youtubeurl'] = 'Endereço Youtube';
$string['youtubeurl_desc'] = 'Endereço da página de Youtube';
$string['linkedinurl'] = 'Endereço Linkedin';
$string['linkedinurl_desc'] = 'Endereço da página de Linkedin';
...
$string['featuredcategoriescopy'] = 'A escola de Feitiçaria oferece uma panóplia de temas para escolher. <a href="course/" >Explore-os!</a>';
...
$string['herotitle_desc'] = 'Texto a imprimir por cima do destaque principal. Cabeçalho Heading 1.';
...
$string['herolink_desc'] = 'Endereço para criar o link no botão do destaque principal. Por omissão remete para a página com a lista de todas as disciplinas.';
