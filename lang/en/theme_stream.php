...
$string['herotitle_desc'] = 'Text to show on top of the first image. Heading 1 title.';
$string['heromotto'] = 'Hero Motto';
$string['heromotto_desc'] = 'Motto to print after hero image highlight.';
$string['herolink'] = 'Link URL';
$string['herolink_desc'] = 'URL to print the link for the hero button. Default links to the course full list page.';
$string['herolinktext'] = 'All courses';
